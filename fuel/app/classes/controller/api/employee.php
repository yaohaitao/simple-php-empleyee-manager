...
class Controller_Api_Employee extends \Fuel\Core\Controller_Rest {
    ...
    public function get_get_employee() {
        ...
        $employee = Model_Employee::get_employee($employee_id);
    ...
    public function get_list_employee() {
        ...
        $employees = Model_Employee::list_employee();
    ...
    public function get_search_employee() {
        ...
        $result = Model_Employee::search_employee($condition);
    ...
    public function get_insert_employee() {
        ...
        $result = Model_Employee::insert_employee($employee_props);
    ...
    public function get_update_employee() {
        ...
        $result = Model_Employee::update_employee($employee_props);
    ...
    public function get_delete_employee() {
        ...
        $result = Model_Employee::delete_emloyee($employee_id);
